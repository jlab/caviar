//copied from https://github.com/nf-core/rnaseq/blob/3.9/modules/nf-core/modules/sortmerna/main.nf
//use database: https://github.com/sortmerna/sortmerna/releases/download/v4.3.4/database.tar.gz
